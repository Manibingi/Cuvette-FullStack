        ...
        <div className="job-desc">
          ...
          <div className="bottom-job-desc">
            <div className="dec-time flex">
              <p>1w ago</p>
              <span
                style={{ fontSize: "2rem", transform: "translateY(-10px)" }}
              >
                .
              </span>
              <p>Full Time</p>
            ...
            <div className="place">
              {jobFormData ? jobFormData.location : ""}
            </div>
            ...
            <div className="skill-req-des">
              ...
              <div className="about-skills-req flex">
                {jobFormData &&
                  jobFormData.skillsRequired &&
                  jobFormData.skillsRequired.map((skill) => {
                    return (
                      <p className="sr" key={id}>
                        {skill}
                      </p>
                    );
                  })}
